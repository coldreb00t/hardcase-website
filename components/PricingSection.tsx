  ...
  const plans = [
    {
      ...
      period: 'разово',
      description:
        'Полная программа возвращения силы на 12 недель, под зал. Для фазы, когда боль уже позади, а сила и уверенность не вернулись. Для тех, кто дисциплинированно делает сам.',
    },
    {
      name: 'С тренером',
      price: '17 000 ₽',
