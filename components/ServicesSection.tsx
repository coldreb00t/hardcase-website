      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Услуги Hardcase построены на инновационной модульной системе, которая обеспечивает точный контроль и своевременную корректировку
            всех процессов оздоровления. Каждый модуль разработан для максимальной эффективности и удобства использования
          </p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-lg text-white/90 leading-relaxed mb-6">
                Hardcase представляет собой революционный проект в сфере здравоохранения, который объединяет экспертные знания,
                передовые технологии и научно обоснованные методики для достижения конкретных целей в области оздоровительного фитнеса,
